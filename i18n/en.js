...
window.TRANSLATIONS['en'] = {
    ...
    backgroundBlurHint: 'Soften the background so cards and search stay in focus.',
    ...
    backgroundFilterHint: 'Add a white or black overlay to boost legibility.',
    filterNone: 'None',
    ...
    debugPanelDescription: 'Display a live debug console in the bottom-right corner when troubleshooting.',
    enableDebugPanel: 'Enable debug overlay',
    disableDebugPanel: 'Disable debug overlay',
    debugStatusOn: 'Debug overlay enabled',
    debugStatusOff: 'Debug overlay disabled',
    // Startup URL
    startupSection: 'Startup Settings',
    startupUrlLabel: 'Auto-open webpage on startup',
    startupUrlDescription: 'Automatically redirect to a specified URL when opening a new tab',
    startupStatusOff: 'Startup page disabled',
    startupStatusOn: 'Startup page enabled',
    enableStartup: 'Enable',
    disableStartup: 'Disable',
    startupUrlInputLabel: 'URL',
    startupUrlPlaceholder: 'https://example.com',
    startupUrlHint: 'Enter complete URL including https://',
    startupUrlInvalid: 'Please enter a complete URL including https://',
    // Search loading
    searchingText: 'Searching...',
    weatherSection: 'Weather',
    weatherToggleHeading: 'Weather widget',
    weatherDescription: 'Show the current conditions powered by Open-Meteo.',
    enableWeather: 'Enable weather widget',
    disableWeather: 'Disable weather widget',
    ...
    weatherStatusLocationNotFound: 'Could not find that location. Try a different name.',
    weatherStatusLocationMissing: 'Set a location in Settings to see the weather.',
    weatherWind: 'Wind {speed} km/h',
    weatherLastUpdated: 'Updated {time}',
    weatherWidgetLabel: 'Weather',
    weatherConditionClear: 'Clear sky',
    weatherConditionMostlyClear: 'Partly cloudy',
    weatherConditionCloudy: 'Cloudy',
    weatherConditionFog: 'Foggy',
    weatherConditionDrizzle: 'Light drizzle',
    weatherConditionRain: 'Rainy',
    weatherConditionHeavyRain: 'Heavy rain',
    weatherConditionFreezingRain: 'Freezing rain',
    weatherConditionSnow: 'Snowy',
    weatherConditionSnowShower: 'Snow showers',
    weatherConditionThunderstorm: 'Thunderstorm',
    weatherConditionUnknown: 'Unknown conditions',
    // Gradient presets
    ...
    alertIconFetched: 'Icon automatically filled! Download speed may vary based on your connection.',
